# Chrome Web Store Listing — DJ Share Audio for X Spaces
...
**Short Description**  
Mix captured browser tab audio (like YouTube or Spotify) directly into your X (Twitter) Spaces microphone broadcast in real-time.

**Detailed Description**  
DJ Share Audio is a powerful tool designed for X Spaces hosts, speakers, and DJs who want to share high-quality audio directly into their live broadcasts. Instead of holding a microphone to your speakers or relying on messy physical setups, this extension creates a virtual audio mixer inside your browser.
...
Privacy Note:
DJ Share Audio processes all audio stream captures and mixing entirely on your local device. No audio recording or user-identifiable data is collected, stored, or transmitted off-device.
...
|------------|------|---------------|
| `tabCapture` | permissions | Required to capture the audio output stream of the selected browser tab to route it to X. |
...
**Publisher Name**  
Senior Chrome Extension Developer

**Contact Email**  
developer@example.com

**Support URL / Email**  
https://github.com/logeshrajappa/dj-share-audio/issues

## Version History

| Version | Date | Changes | Status |
|---------|------|---------|--------|
| 1.0.2 | 2026-06-05 | Initial release with mic detection and tab audio mixing. | Draft |
